...
stock AnnounceSIClasses()
{
    ...
    switch (iSpawns) {
	    case 5: {
            PrintToSurvivors(
                    "\x01[\x05TS\x01] Special Infected: \x04%s\x01, \x04%s\x01, \x04%s\x01, \x04%s\x01, \x04%s\x01.",
        ...
        case 4: {
            PrintToSurvivors(
                    "\x01[\x05TS\x01] Special Infected: \x04%s\x01, \x04%s\x01, \x04%s\x01, \x04%s\x01.",
                    g_csSIClassName[iSpawnClass[0]],
                    g_csSIClassName[iSpawnClass[1]],
                    g_csSIClassName[iSpawnClass[2]],
                    g_csSIClassName[iSpawnClass[3]]
        ...
        case 3: {
            PrintToSurvivors(
                    "\x01[\x05TS\x01] Special Infected: \x04%s\x01, \x04%s\x01, \x04%s\x01.",
                    g_csSIClassName[iSpawnClass[0]],
                    g_csSIClassName[iSpawnClass[1]],
                    g_csSIClassName[iSpawnClass[2]]
                );
        ...
        case 2: {
            PrintToSurvivors(
                    "\x01[\x05TS\x01] Special Infected: \x04%s\x01, \x04%s\x01.",
                    g_csSIClassName[iSpawnClass[0]],
                    g_csSIClassName[iSpawnClass[1]]
                );
        }
        case 1: {
           /* PrintToSurvivors(
                    "\x01[\x05TS\x01] Special Infected: \x04%s\x01.",
                    g_csSIClassName[iSpawnClass[0]]
                );*/
        }
    }
